...
class IcaAPI:
    ...
    def get_favorite_products(self) -> [IcaStore]:
    ...
    def get_product_categories(self) -> [IcaProductCategory]:
        url = str.format(get_rest_url(ARTICLEGROUPS_ENDPOINT), datetime.date)
        return get(self._session, url, self._auth_key)
    ...
    def sync_shopping_list(self, data: IcaShoppingList):
        ...
        data2 = post(self._session, url, self._auth_key, data)
